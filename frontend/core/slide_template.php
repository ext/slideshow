...
class Field {
	...
	public function __construct($type, $name, $font, $size, $position){
		$this->type = $type;
		$this->name = $name;
...
class TextField extends Field {
	...
	public function __construct($name, $align, $font, $size, $position){
		parent::__construct(Field::type_text, $name, $font, $size, $position);
...
class TextAreaField extends Field {
	...
	public function __construct($name, $align, $boxsize, $font, $size, $position, $width, $height){
		parent::__construct(Field::type_textarea, $name, $font, $size, $position);
		$this->align = $this->parse_alignment($align);
