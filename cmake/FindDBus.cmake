...
ELSE (WIN32)
	...
	SET( DBUS_INCLUDE_PATH ${_dbusLibPath}/dbus-1.0/include ${DBUS_INCLUDE_PATH} )
ENDIF (WIN32)

IF ( DBUS_INCLUDE_PATH AND DBUS_LIBRARY )
	SET( DBUS_FOUND TRUE CACHE BOOL "Set to 1 if DBus is found, 0 otherwise")
ELSE ( DBUS_INCLUDE_PATH AND DBUS_LIBRARY )
	SET( DBUS_FOUND FALSE CACHE BOOL "Set to 1 if DBus is found, 0 otherwise")
